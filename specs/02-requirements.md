...
| FR-003 | The GeoComp menu MUST present seven entries in this order: Total Station, Level, GNSS, Gravimetry, Integration, Analysis, and Global Settings, the last separated from the rest. | tex §Painel de Configuração Global; `fig/menu_estrutura.png` (five technique submenus and Global Settings); Analysis added in phase P2 for the operations belonging to no single technique, settling what [`15-ui-menu-and-settings.md`](./15-ui-menu-and-settings.md) §1.1 left open |
| FR-004 | Menu groups Total Station, Level, GNSS, Gravimetry, Integration and Analysis MUST each open a submenu listing the operations specified in [`15-ui-menu-and-settings.md`](./15-ui-menu-and-settings.md). | tex §Painel de Configuração Global |
