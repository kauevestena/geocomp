...
| 22 | [`22-reference-data-sources.md`](./22-reference-data-sources.md) | Where the reference data can come from: candidate sources, what was verified, and what each unblocks |
