...
| 22 | [`22-reference-data-sources.md`](./22-reference-data-sources.md) | Where the reference data comes from: the 34 published network adjustments GeoComp now reproduces (RD-11), and the candidate sources for the datasets still to assemble |
