...
A integração entre a Geodésia rigorosa e os Sistemas de Informação Geográfica (SIG) é uma tendência aconselhável para a gestão eficiente de dados espaciais \cite{monico_gnss}. Enquanto os SIGs tradicionalmente focam na análise espacial e visualização, muitas vezes simplificando questões de referência e precisão, a Geodésia fornece o arcabouço matemático para garantir a qualidade posicional. Ferramentas que unem esses domínios permitem que o ciclo completo — da observação de campo ao mapa final — seja tratado em um ambiente único, preservando metadados de qualidade e facilitando a tomada de decisão baseada em dados confiáveis.
...
A propagação de covariâncias será aplicada sistematicamente em diversas etapas do GeoComp:
